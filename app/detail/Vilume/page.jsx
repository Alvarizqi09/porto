        ...
        >
          ...
          <div className="p-8 md:p-12">
            <motion.div variants={fadeIn} className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                  Vilume is a web application that allows users to create and
                  share their own custom color palettes. It's a great tool for
                  designers and developers who need to quickly generate color
              ...
              <div>
                ...
                <motion.div variants={fadeIn} className="flex flex-wrap gap-3">
                  {["Next.js", "React", "Tailwind CSS", "MongoDB"].map(
                    (tech, index) => (
                      <motion.span
                        key={index}
            ...
            <motion.div variants={fadeIn} className="text-center mt-12">
              <Link href="https://vilume.vercel.app" passHref>
                <motion.div
