...
const HomeClient = ({ initialCvLink = "", initialCvLinkEnglish = "" }) => {
  ...
  const cvLink = data?.about?.cvLink || initialCvLink;
  const cvLinkEnglish = data?.about?.cvLinkEnglish || initialCvLinkEnglish;
